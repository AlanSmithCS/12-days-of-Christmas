...
public class LZW_Compression {
    ...
    public static String lzw_compress(final String input) {
        ...
        for (int x=0; x<input.length(); x++) { //Fill Map with single characters
        ...
        for (int i=-128; i<stringMap.size()-128; i++) {
            ...
            if (inStringMap(temp, stringMap)) { // If it exists
                phrase = temp;
            } else { // If it doesn't exist within the Map
                str_pos++;
                phrase += current_char;
    ...
    public static void main(String[] args) {
        ...
        String lyrics = "On the twelfth day of Christmas, my true love sent to me," +
